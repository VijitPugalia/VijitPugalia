...
```typescript
import { Developer } from "@vijit/core";

const VijitPugalia: Developer = {
  name: "Vijit Vijay Pugalia",
  role: "Frontend & Full-Stack Engineer / AI Researcher",
  portfolio: "https://vijitpugalia.com",
  traits: ["Pixel-Perfect UI/UX", "High-Performance Web", "Clean Architecture"],
  currentFocus: "Crafting immersive frontend experiences and bridging AI models with modern web interfaces 🚀",
  funFact: "Turning coffee ☕ into fluid 60fps web apps and neural models."
};
```

---

### 🎨 Frontend & Design Arsenal
...
<table>
  <tr>
    <td width="50%">
      ...
      <p align="center">
        <a href="https://github.com/VijitPugalia/Human-Activity-Recognition"><b>Explore Code →</b></a>
      </p>
    </td>
    <td width="50%">
      ...
      <p align="center">
        <a href="https://github.com/VijitPugalia/Shape_AI_Python_Machine_Learning"><b>Explore Code →</b></a>
      </p>
    </td>
  </tr>
</table>
